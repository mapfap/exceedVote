...
class VoteItemsControllerTest < ActionController::TestCase
  ...
  test "should create vote_item" do
    assert_difference('VoteItem.count') do
      post :create, vote_item: { project_id: @vote_item.project_id, topic_id: @vote_item.topic_id, vote_id: @vote_item.vote_id }
    end
  ...
  test "should update vote_item" do
    patch :update, id: @vote_item, vote_item: { project_id: @vote_item.project_id, topic_id: @vote_item.topic_id, vote_id: @vote_item.vote_id }
    assert_redirected_to vote_item_path(assigns(:vote_item))
  end
